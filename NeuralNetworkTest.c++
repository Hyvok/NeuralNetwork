...
BOOST_AUTO_TEST_CASE(neural_network_test)
{
    ...
    testNetwork.getValues();
    std::cout << "testNetwork.updateState(): " << testNetwork.updateState() << "\n";
    testNetwork.getValues();
    //testNetwork.updateState();
    std::cout << "testNetwork.getOutput(): " << testNetwork.getOutput()[0] << "\n";
